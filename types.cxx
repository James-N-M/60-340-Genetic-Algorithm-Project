...
namespace cs340 
{
  ...
  double schedule::score(runtime_matrix const& matrix) const
  {
    ...
    /* TODO: WRITE CODE HERE */
	multimap<size_t, size_t> machine_schedule;
    ...
    /* TODO: WRITE CODE HERE */
    size_t total_runtime = numeric_limits<size_t>::min();
	...
	auto range = machine_schedule.equal_range(m);
      ...
      size_t accum = accumulate(range.first,
                              range.second,
                              size_t(0),
                              [&matrix](size_t const& sum, auto const& elem) -> size_t {
      ...
      // outside of the loop.
        ...
        // TODO: WRITE CODE HERE */
      total_runtime = std::max(accum, total_runtime);
    }
